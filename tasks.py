...
DEFAULT_DOCKER_COMPOSE_FILES = 'docker-compose.yml'


def docker_exec(c, command, executor='docker exec', container_name='django', pty=True, envs={}):
...
def gunicorn(c):
    docker_exec(
        ...
        "-b :8000 django.wsgi:application"
    )
